...
const HomepageHeading = ({ mobile }) => (
  <Container text>
    ...
    <Header
      as="h2"
      content="A Blockchain Medical Record System Ensure That Your Records Are Safe And Sound"
      inverted
      style={{
      ...
      <Media greaterThan="mobile">
        ...
        >
          <Segment
            // inverted
            textAlign="center"
            style={{ minHeight: 580, padding: "1em 0em" }}
            vertical
          >
            <Menu
              color="blue"
            ...
            >
              <Link route="/">
                <a className="item" style={{ fontFamily: "cursive" }}>
                  <i class="american sign language interpreting icon" style={{fontSize:'24px'}} ></i>
                  Medicord
                </a>
              </Link>
        ...
        <Grid.Row>
          <Grid.Column width={8}>
            ...
            <p style={{ fontSize: "1.33em" }}>
              ...
              needs... through reliable medical record systems.
            </p>
            <Header as="h3" style={{ fontSize: "2em" }}>
        ...
        <Grid.Row textAlign="center">
          ...
          <Grid.Column style={{ paddingBottom: "5em", paddingTop: "5em" }}>
            ...
            <p style={{ fontSize: "1.33em" }}>
              ...
              />
              <b>Dr Rittwika</b>, Surgeon at City Hospital
            </p>
          </Grid.Column>
        </Grid.Row>
      </Grid>
